...
function NavbarNew() {
  ...
  // Do not render Navbar on /dashboard route
  if (location.pathname === '/dashboard') {
    return null; // Return null to hide the Navbar on this route
  }
  ...
  return (
    <div className='sticky top-0 bg-white z-50 flex items-center justify-between text-sm py-4 mb-5 border-b border-b-grey-400 font-outfit md:max-xl:mx-[-10%]' data-aos="fade-down">
      ...
      <div className='xl:hidden'>
        {!dropDown ? <div className="mr-4" onClick={() => setDropDown(!dropDown)}><Menu /></div> :
          <div className="mr-4" onClick={() => setDropDown(!dropDown)}><X /></div>}
